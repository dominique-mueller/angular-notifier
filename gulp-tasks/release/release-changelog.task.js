...
gulp.task( 'release:changelog', ( done ) => {
    ...
    gulp
        ...
        .pipe( conventionalChangelog( {
            ...
            mainTemplate: fs.readFileSync( './gulp-tasks/release/custom-changelog-main.hbs', 'utf-8' ), // Custom main template
            headerPartial: fs.readFileSync( './gulp-tasks/release/custom-changelog-header.hbs', 'utf-8' ) // Custom header template
        } ) )
