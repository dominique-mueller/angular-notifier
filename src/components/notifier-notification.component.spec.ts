	...
	describe( 'Notifier Notification Component', () => {
		...
		describe( '(show)', () => {
			...
			it( 'should show', fakeAsync( () => {
				...
				const showCallback: () => {} = jasmine.createSpy( 'showCallback' );
			...
			it( 'should show (with animations)', fakeAsync( () => {
				...
				spyOn( componentFixture.nativeElement, 'animate' ).and.callFake( () => {
					return {
		...
		describe( '(hide)', () => {
			...
			it( 'should hide', fakeAsync( () => {
				...
				const hideCallback: () => {} = jasmine.createSpy( 'hideCallback' );
		...
		describe( '(shift)', () => {
			...
			it( 'should shift to make place on top', fakeAsync( () => {
				...
				const shiftCallback: () => {} = jasmine.createSpy( 'shiftCallback' );
		...
		describe( '(behaviour)', () => {
			...
			it( 'should hide automatically after timeout', fakeAsync( () => {
				...
				spyOn( componentInstance, 'onClickDismiss' ).and.callThrough();
				tick();
			...
			it( 'should pause the autoHide timer on mouseover, and resume again on mouseout', fakeAsync( () => {
				...
				componentInstance.show();
				spyOn( componentInstance, 'onClickDismiss' ).and.callThrough();
				spyOn( timerService, 'pause' ).and.callThrough();
				spyOn( timerService, 'continue' ).and.callThrough();
			...
			it( 'should restart the autoHide timer on mouseover', fakeAsync( () => {
				...
				componentInstance.show();
				spyOn( componentInstance, 'onClickDismiss' ).and.callThrough();
				spyOn( timerService, 'stop' ).and.callThrough();
				spyOn( timerService, 'start' ).and.callThrough();
